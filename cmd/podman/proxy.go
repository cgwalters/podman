...
// NewPolicyContext returns a new signature.PolicyContext.
func NewPolicyContext() *signature.PolicyContext {
...
func (opts *proxyOptions) run(cmd *cobra.Command, args []string) error {
